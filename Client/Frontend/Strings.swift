...
extension Strings {
    ...
    public static let AppMenuCloseTabTitleString = NSLocalizedString("Menu.CloseTabAction.Title", tableName: "Menu", value: "Close Tab", comment: "Label for the button, displayed in the menu, used to close the current tab.")
